...
<head>
    ...
    <link rel="icon" type="image/png" href="${res}/amaze/i/favicon.png">
    <link rel="apple-touch-icon-precomposed" href="${res}/amaze/i/app-icon72x72@2x.png">
    <meta name="apple-mobile-web-app-title" content="Amaze UI" />
    <link rel="stylesheet" href="${res}/amaze/css/amazeui.min.css"/>
    <link rel="stylesheet" href="${res}/amaze/css/admin.css">
</head>
<body>
<!--[if lte IE 9]>
...
<header class="am-topbar am-topbar-inverse admin-header">
    <div class="am-topbar-brand">
        <strong>HI</strong> <small>后台管理模板</small>
    </div>
...
<div class="am-cf admin-main">
            ...
            <ul class="am-list admin-sidebar-list">
                <c:forEach items ="${menus}" var ="menu" >
                    <c:if test="${menu.subMenus == null}">
                        <li><a href="<c:out value="${menu.fullUrl}"/>" target="ifm"><span class="am-icon-table"></span><c:out value="${menu.name}" /></a></li>
                    </c:if>
                    <c:if test="${menu.subMenus != null}">
                        <li class="admin-parent">
                            <a class="am-cf" data-am-collapse="{target: '#collapse-nav'}"><span class="am-icon-file"></span> <c:out value="${menu.name}" /> <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
                            <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
                                <c:forEach items="${menu.subMenus}" var="subMenu" >
                                    <li><a href="<c:out value="${subMenu.fullUrl}"/>"  target="ifm"><span class="am-icon-calendar"></span> <c:out value="${subMenu.name}" /></a></li>
                                </c:forEach>
                            </ul>
                        </li>
                    </c:if>
    ...
    <!-- content start -->
    <div class="admin-content"><iframe src="/index" id="ifm" name="ifm" scrolling="yes"  width="100%" height="100%" frameborder="0" >
                    ...
                    <div class="am-panel am-panel-default">
                        ...
                        <div id="collapse-panel-2" class="am-in">
                            <table class="am-table am-table-bd am-table-bdrs am-table-striped am-table-hover">
                                ...
                                <tr>
                                    <td class="am-text-center"><img src="${res}/amaze/i/examples/admin-chrome.png" alt=""></td>
                                    <td>Google Chrome</td>
                                    <td>3,005</td>
                                </tr>
                                <tr>
                                    <td class="am-text-center"><img src="${res}/amaze/i/examples/admin-firefox.png" alt=""></td>
                                    <td>Mozilla Firefox</td>
                                    <td>2,505</td>
                                </tr>
                                <tr>
                                    <td class="am-text-center"><img src="${res}/amaze/i/examples/admin-ie.png" alt=""></td>
                                    <td>Internet Explorer</td>
                                    <td>1,405</td>
                                </tr>
                                <tr>
                                    <td class="am-text-center"><img src="${res}/amaze/i/examples/admin-opera.png" alt=""></td>
                                    <td>Opera</td>
                                    <td>4,005</td>
                                </tr>
                                <tr>
                                    <td class="am-text-center"><img src="${res}/amaze/i/examples/admin-safari.png" alt=""></td>
                                    <td>Safari</td>
                                    <td>505</td>
                                </tr>
                                </tbody>
...
<script src="${res}/amaze/js/amazeui.ie8polyfill.min.js"></script>
<![endif]-->

<!--[if (gte IE 9)|!(IE)]><!-->
<script src="${res}/amaze/js/jquery.min.js"></script>
<!--<![endif]-->
<script src="${res}/amaze/js/amazeui.min.js"></script>
<script src="${res}/amaze/js/app.js"></script>
</body>
</html>
