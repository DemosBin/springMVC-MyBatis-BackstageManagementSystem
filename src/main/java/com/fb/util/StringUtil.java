...
public class StringUtil {
     ...
     *
     * @param str         字符串
     * @param fromCharset 原编码集
     * @param toCharset   目的编码集
     * @return 转换后的字符串
     */
     ...
     *
     * @param strTime 需要格式化的字符串参数(如 "2005-01-12")
     * @return 格式化后的日期
     ...
     * 字符串替换函数
     *
     * @param strSource  String 原来的字符串
     * @param strReplace String 要替换掉的字符串
     * @param strNew     String 新的字符串
    ...
    /**
     * 存储全局信息
     * 1 key：ORDEREXPRESS_KEY value:实时物流信息
     * 若物流获取超时则 put "0"
     */
    public static final Map<String, String> pubMap = new HashMap<String, String>();
    public static final String ORDEREXPRESS_KEY = "orderexpress";
     ...
     * @throws IOException
     */
    public static void gteStringByUrl(String url) throws IOException {
        StringBuffer buffer = new StringBuffer();
        InputStream is = null;
        BufferedReader br = null;
        for (int i = 0; i < 6; i++) {
            log.info("第" + (i + 1) + "次调用快递接口");
            try {
...
//				System.out.println("----"+i);
                ...
                StringUtil.pubMap.put(StringUtil.ORDEREXPRESS_KEY, "0");
            }
        }
        StringUtil.pubMap.put(StringUtil.ORDEREXPRESS_KEY, buffer.toString());
